...
const allIcon: React.FC<allIconProps> = ({ size = 24, color = 'currentColor' }) => (
  <svg width={`${size}px`} height={`${size}px`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clip-path="url(#clip0_6908_884)">
      ...
      />
      <path
        d="M9.2001 8.6001H7.6001L8.17323 11.0001H7.2001V12.6001H8.55532L9.2001 15.3001H11.1001L12.0001 11.5313L12.9001 15.3001H14.8001L15.4449 12.6001H16.8001V11.0001H15.827L16.4001 8.6001H14.8001L13.8001 12.7876L12.8001 8.6001H11.2001L10.2001 12.7876L9.2001 8.6001Z"
        fill={color}
      />
    </g>
    <defs>
